...
\TODO{namelists for CICE (see AK email to Petra 2017-11-15)}
\TODO{namelists for MATM}
...
%\newpage
%\definecolor{hilite}{cmyk}{0, 0, 0.9, 0}\renewcommand{\nmldiffer}[1]{\colorbox{hilite}{#1}}\setlength{\fboxsep}{0pt} % colour highlight of differing variables (requires color package)
%\section{0.25deg ACCESS-OM2 configs (differences highlighted)}
%\doscript{/Users/andy/anaconda/bin/python3 /Users/andy/bin/nmltab.py --format latex  new_accessom2_025deg_jra55_ryf_input.nml original-tidy/kiss_accessom2_025deg_jra55_ryf_logfile.000000.out }
...
\definecolor{hilite}{cmyk}{0, 0, 0.9, 0}\renewcommand{\nmldiffer}[1]{\colorbox{hilite}{#1}}\setlength{\fboxsep}{0pt} % colour highlight of differing variables (requires color package)
\subsection{accessom2_1deg_jra55_ryf}
\doscript{/Users/andy/anaconda/bin/python3 /Users/andy/bin/nmltab.py  --format latex original/hogg_accessom2_1deg_jra55_ryf_input.nml new_accessom2_1deg_jra55_ryf_input.nml }
\subsection{accessom2_025deg_jra55_ryf}
We aim to have as few differences as possible, as this is where we've invested most SU...
\doscript{/Users/andy/anaconda/bin/python3 /Users/andy/bin/nmltab.py --format latex original/kiss_accessom2_025deg_jra55_ryf_input.nml new_accessom2_025deg_jra55_ryf_input.nml}
\subsection{accessom2_01deg_jra55_ryf}
\doscript{/Users/andy/anaconda/bin/python3 /Users/andy/bin/nmltab.py --format latex original/hogg_accessom2_01deg_jra55_ryf_input.nml new_accessom2_01deg_jra55_ryf_input.nml}
...
\newpage
\section{All variables in GFDL \& ACCESS configs (differences highlighted)}
\definecolor{hilite}{cmyk}{0, 0, 0.9, 0}\renewcommand{\nmldiffer}[1]{\colorbox{hilite}{#1}}\setlength{\fboxsep}{0pt} % colour highlight of differing variables (requires color package)
...
\newpage
\section{All variables in new configs (differences highlighted)}
\definecolor{hilite}{cmyk}{0, 0, 0.9, 0}\renewcommand{\nmldiffer}[1]{\colorbox{hilite}{#1}}\setlength{\fboxsep}{0pt} % colour highlight of differing variables (requires color package)
\doscript{/Users/andy/anaconda/bin/python3 /Users/andy/bin/nmltab.py --format latex       new_accessom2_1deg_jra55_ryf_input.nml           new_accessom2_025deg_jra55_ryf_input.nml        new_accessom2_01deg_jra55_ryf_input.nml}
...
\newpage
\section{1 deg configs (differences only)}
%\definecolor{hilite}{cmyk}{0, 0, 0.9, 0}\renewcommand{\nmldiffer}[1]{\colorbox{hilite}{#1}}\setlength{\fboxsep}{0pt} % colour highlight of differing variables (requires color package)
\renewcommand{\nmldiffer}[1]{#1} % no special display of differing variables
\doscript{/Users/andy/anaconda/bin/python3 /Users/andy/bin/nmltab.py  -d --format latex     original/russ-accessom-mom4p1-input.nml     original/hogg_accessom2_1deg_jra55_ryf_input.nml     1deg_jra55v13_ryf9091_spinup_A-input.nml     new_accessom2_1deg_jra55_ryf_input.nml     original/GFDL_ESM2M_input-cut.nml}
